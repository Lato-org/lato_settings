...
namespace :lato_settings do
  namespace :install do
    ...
    task :application do
      ...
      gem_layout_path = LatoSettings::Engine.root.join('app', 'views', 'layouts', 'lato_settings').to_s
      app_layout_path = Rails.root.join('app', 'views', 'layouts', 'lato_settings').to_s
